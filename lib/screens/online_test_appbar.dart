...
class online_test_appbar extends StatefulWidget {
  const online_test_appbar({Key key}) : super(key: key);

  @override
  _online_test_appbarState createState() => _online_test_appbarState();
}

class _online_test_appbarState extends State<online_test_appbar>
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        shrinkWrap: true,
        itemBuilder: (BuildContext context, int index) {
          return YourAnsCard("Figma Design", "24", "assets/image/banner.jpeg");
        },
      ),
    );
  }
