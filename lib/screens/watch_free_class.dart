...
class WatchFreeClass extends StatefulWidget {
  const WatchFreeClass({Key key}) : super(key: key);

  @override
  _WatchFreeClassState createState() => _WatchFreeClassState();
}

class _WatchFreeClassState extends State<WatchFreeClass> {
  String token;
